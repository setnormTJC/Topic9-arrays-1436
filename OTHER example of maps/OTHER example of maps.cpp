...
int main()
{
	...
	std::map<std::pair<float, float>, std::string> coordinatesToCityNames =
	{
		{{32.30, -95.29}, "Tyler"},
		{{32.36, -94.87}, "Kilgore"}
	};

	float latitude = 32.30; 
	float longitude = -95.29; 

	std::cout << "The name of city at: " << coordinatesToCityNames[{latitude, longitude}]
		<< "\n";
